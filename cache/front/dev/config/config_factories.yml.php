...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/Users/hectorsauza/speeder/log/front_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/Users/hectorsauza/speeder/cache/front/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/Users/hectorsauza/speeder/apps/front/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'dmFrontRouting');
      $cache = new dmMetaCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/Users/hectorsauza/speeder/cache/front/dev/config/routing',
  'lifetime' => 31556926,
  'prefix' => '/Users/hectorsauza/speeder/apps/front/routing',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/Users/hectorsauza/speeder/cache/front/dev/template',
  'lifetime' => 86400,
  'prefix' => '/Users/hectorsauza/speeder/apps/front/template',
)));
